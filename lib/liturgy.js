...
const Liturgy = (() => {
  ...
  function canticleInfo(key) {
    const c = CANTICLES[key];
    return c ? { cita: c.cita, ref: c.ref, texto: c.lines.join('\n') } : null;
  }
